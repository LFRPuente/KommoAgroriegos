...
$apiKey = $apiKeyLine -replace '^N8N_API_KEY=', ''
...
$resp | ConvertTo-Json -Depth 100 | Set-Content -Path 'c:\Users\luis_\OneDrive\Desktop\KommoAgroriegos\.tmp_wf_before_recepcion_patch.json' -Encoding UTF8
Write-Output "OK"
